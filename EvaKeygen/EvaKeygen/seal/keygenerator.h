    ...
    */
    ...
    public:
        ...
        */
		...
		void combine_relin_keys(RelinKeys &rlk1, RelinKeys rlk2, SecretKey sk1, SecretKey sk2, int decomposition_bit_count);
        /**
        ...
        */
        GaloisKeys galois_keys(int decomposition_bit_count, uint64_t *pk1,
        ...
        */
		...
		void combine_galois_keys(GaloisKeys &gk1, GaloisKeys &gk2, int decomposition_bit_count);
